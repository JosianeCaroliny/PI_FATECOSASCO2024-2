...
public class EntrarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView produtor = findViewById(R.id.textView15);
        ...
        Button buttonEntrar = findViewById(R.id.btnPedidoRecebido);
        buttonEntrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Intent para abrir a página CLPerfilActivity
                Intent intent = new Intent(EntrarActivity.this, CL_04_1_produtos.class);
                startActivity(intent);
            }
        });
        ...
        produtor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent para abrir a página CLPerfilActivity
                Intent intent = new Intent(EntrarActivity.this, PR_02_pedidos_home.class);
                startActivity(intent);
            }
        });
